...
#   MIN_MODEL_AUC, MIN_PRECISION_AT_TOP_DECILE, MIN_PROMOTION_PREDICTION_ROWS
...
docker run --rm \
  ...
  -e MIN_MODEL_AUC="${MIN_MODEL_AUC:-0.65}" \
  -e MIN_PRECISION_AT_TOP_DECILE="${MIN_PRECISION_AT_TOP_DECILE:-0.0}" \
